...
// sha3: 637ccf92de798f59ec380572a075fce4549a17b91cb9f40ca1f5112fc981fd99
...
mod __parse__Prog {
    ...
    {
        // Expr = "let", Var, "=", Expr, "in", Expr => ActionFn(4);
    ...
    {
        // Prog = "def", "main", "(", Var, ")", ":", Expr => ActionFn(1);
    ...
    {
        // Var = r#"[a-zA-Z][a-zA-Z0-9_]*"# => ActionFn(7);
        let __sym0 = __pop_Variant0(__symbols);
        let __start = __sym0.0.clone();
        let __end = __sym0.2.clone();
...
{
    Expression::Let(x, Box::new(e1), Box::new(e2))
}
