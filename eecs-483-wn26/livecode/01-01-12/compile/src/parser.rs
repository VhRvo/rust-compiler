...
// sha3: 271e12a6a908f571c4fc1075f880a96cff226bfa7c7f3a05f9a79bda0b5f406e
...
#[allow(unused_variables)]
fn __action1<'input>(input: &'input str, (_, n, _): (usize, i64, usize)) -> Expression {
    Expression::Number(n)
}
...
#[allow(unused_variables)]
fn __action4<'input>(input: &'input str, (_, s, _): (usize, &'input str, usize)) -> i64 {
    s.parse().unwrap()
}
